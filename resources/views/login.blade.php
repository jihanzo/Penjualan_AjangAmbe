...
<!-- <div class="vid-container">
  ...
  <body class="hold-transition login-page" style="background-color: rgb(0, 114, 189); background-size: cover";>
    <div class="login-box">
        <!-- /.login-logo -->
        <div class="card card-outline card-primary" style="background: white; border: 2px solid rgba(255, 255, 255, .2)";>
            <div class="card-header text-center">
                <h1 class="h1">Ajang<b>Ambe</b></h1>
            </div>
            <div class="card-body">
                <p class="login-box-msg"  style="color: red;">Please Login</p>
