                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                @foreach($dataDetailtransaksi as $dt)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $dt->produk->namaproduk }}</td>
                                    <td>@money($dt->harga)</td>
                                    <td>{{ $dt->qty}}</td>
                                    <td>@money($dt->harga * $dt->qty)</td>
                                    <td><button class="btn btn-sm btn-danger" wire:click="delete({{ $dt->id }})"><i class=" fas fa-trash">hapus</i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="card-footer text-end">
                        ...
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <th>:</th>
                                <th>
                                    <input type="number" step="any" class="form-control text-end" wire:model="uang" style="width: 150px; height: 40px;" placeholder="Masukkan jumlah uang">
                                </th>
                                </th>
                            </tr>
                            </div>
